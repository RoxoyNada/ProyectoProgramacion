...
<!-- Topbar End -->
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <!-- FORM START -->
            <div class="col-lg-4">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Agregar Usuario</span></h5>
                <div class="bg-light p-30 mb-5">
                    ...
                    <form class="mb-30" action="operaciones.jsp">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control border-0 p-4" placeholder="Teléfono" id="telefono" name="telefono">
                        </div>
                        <div class="input-group">
                            <input type="text" class="form-control border-0 p-4" placeholder="Dni" id="dni" name="dni">
                        </div>
                        <div class="pt-2">
                            <button type="submit" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Agregar Usuario</button>
                        </div>
                    </form>
                </div>
            </div>
