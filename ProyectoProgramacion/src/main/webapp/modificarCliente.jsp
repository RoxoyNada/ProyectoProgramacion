...
<!-- Topbar End -->
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item active" href="clientesAdmin.html">Clientes</a>
                    <span class="breadcrumb-item active">Modificar Cliente</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Modificar Cliente</span></h2>
        <div class="row px-xl-5">
                ...
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="modCliente" id="contactForm" novalidate="novalidate">
                        ...
                        <div style="display: flex; justify-content: center; align-items: center ;">
                            <button class="btn btn-primary py-2 px-4" style="margin: 0 auto;"  type="submit" id="sendMessageButton">Modificar Cliente</button>
                        </div>
                    </form>
                </div>
            </div>
